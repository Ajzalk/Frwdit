...
class Translation(object):
  START_TXT = """<b>Hai {}!!</b>
<i>I'm mandan auto filter bot 
This Bot and robot 😂 to One Public channel to Your Personal @ajzalk 
More details /adout</i>"""🔚
  CAPTION = "`{}`\n\n" + str(Config.CAPTION)
...
<b>• Then use /adout commander in @ajzalk bot</b>
...
<b>Name :</b> <code>thendu Forward Bot</code>
<b>Credit :</b> <code>ajzalk</code>
